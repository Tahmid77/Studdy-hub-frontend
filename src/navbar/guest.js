...
function Guest() {
    return (
        <>
            ...
            <footer
                className="absolute bottom-0 left-0 w-screen flex items-center justify-start font-bold bg-slate-900 text-white opacity-90 md:justify-center mt-auto p-10"
            >
